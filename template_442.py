...
DISTANCE=input('Enter distance [SAD, SSD, NCC]:'.format(i))
method=input('Enter method [region, feature]:'.format(i))
SEARCH_RANGE=int(input('Enter search range (need to be integer):'.format(i)))
TEMPLATE_SIZE_X=int(input('Enter template_x_size (need to be odd integer):'.format(i)))
TEMPLATE_SIZE_Y=int(input('Enter template_y_size (need to be odd integer):'.format(i)))
